...
A solução desenvolvida consiste em um serious game de simulação de vendas, criado para apoiar o treinamento da equipe comercial da Cielo por meio de uma experiência interativa e gamificada. No jogo, o usuário assume o papel de um vendedor que percorre um ambiente virtual e interage com diferentes perfis de clientes, participando de simulações de negociação que representam situações reais do processo de venda de maquininhas e soluções da Cielo.

Durante essas interações, o jogador precisa tomar decisões e responder a quizzes contextualizados, que testam seu conhecimento sobre produtos, sua capacidade de identificar as necessidades do cliente e sua habilidade em lidar com objeções comuns do processo comercial. O desempenho nessas decisões determina a pontuação obtida e a progressão dentro do jogo, incentivando o aprendizado por tentativa, erro e correção imediata.

A proposta de valor da solução está em transformar o treinamento tradicional em uma experiência prática, dinâmica e engajadora, permitindo que vendedores pratiquem estratégias de negociação em um ambiente seguro antes de aplicá-las em situações reais. Dessa forma, o jogo contribui para o desenvolvimento de habilidades comerciais, melhora a compreensão dos produtos da empresa e aumenta a preparação dos vendedores para interações com clientes.

A aplicação foi desenvolvida para uso individual em desktop, acessada via navegador, e utiliza mecânicas de gamificação, como níveis progressivos, pontuação e aumento gradual da dificuldade, para manter o engajamento do jogador enquanto promove o aprendizado contínuo.
...
<img src="../../public/assets/NPCs.jpeg" width= 350> 
